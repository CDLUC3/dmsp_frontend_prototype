...
export type PublishTemplateCustomizationMutationVariables = Exact<{
  publishTemplateCustomizationTemplateCustomizationId: Scalars['Int']['input'];
}>;


export type PublishTemplateCustomizationMutation = { __typename?: 'Mutation', publishTemplateCustomization: { __typename?: 'TemplateCustomizationOverview', customizationId: number, customizationIsDirty: boolean, customizationLastCustomized?: string | null, customizationLastCustomizedById?: number | null, customizationLastCustomizedByName?: string | null, customizationMigrationStatus: TemplateCustomizationMigrationStatus, customizationStatus: TemplateCustomizationStatus, versionedTemplateAffiliationId: string, versionedTemplateId: number, versionedTemplateAffiliationName: string, versionedTemplateLastModified: string, versionedTemplateName: string, versionedTemplateVersion: string, errors?: { __typename?: 'TemplateCustomizationErrors', general?: string | null, currentVersionedTemplateId?: string | null, affiliationId?: string | null, templateId?: string | null } | null, sections?: Array<{ __typename?: 'SectionCustomizationOverview', id: number, hasCustomGuidance?: boolean | null, displayOrder: number, migrationStatus?: TemplateCustomizationMigrationStatus | null, name: string, sectionType: CustomizableObjectOwnership, questions?: Array<{ __typename?: 'QuestionCustomizationOverview', displayOrder: number, hasCustomGuidance?: boolean | null, hasCustomSampleAnswer?: boolean | null, migrationStatus?: TemplateCustomizationMigrationStatus | null, id: number, questionType: CustomizableObjectOwnership, questionText: string }> | null }> | null } };
