...
import styles from '../new/newQuestion.module.scss';
import { getQuestionTypes } from "@/utils/questionTypeHandlers";


const QuestionTypeSelectPage: React.FC<{ mode?: "regular" | "customize" }> = ({
  mode = "regular"
}) => {
  ...
  const handleSelect = (
    ...
    if (questionId) {
      ...
      window.location.href = routePath(
        mode === 'customize' ? 'template.q.custom.slug' : 'template.q.slug',
      ...
      if (questionType) {
        ...
        router.replace(routePath(
          ...
          { templateId },
          { section_id: sectionId, step: 2, restore: true }
        ));
      }
    }
  }
