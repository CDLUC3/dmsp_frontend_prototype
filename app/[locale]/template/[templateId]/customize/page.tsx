...
import { updateSectionDisplayOrderAction } from "./actions";
...
const TemplateCustomizePage: React.FC = () => {
  ...
  const CustomizeTemplate = useTranslations("CustomizeTemplate");
        ...
        <aside className="sidebar">
          <div className="status-panel-content side-panel">
            <div className="buttonContainer withBorder mb-5">
              ...
              <Button onPress={() => handlePressPublishTemplate()}>{CustomizeTemplate("buttons.publishCustomization")}</Button>
            </div>
