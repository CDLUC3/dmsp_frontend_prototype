...
describe('DepartmentsPage', () => {
  ...
  it('should render the departments section', () => {
    ...
    expect(screen.getByText('sections.departmentsList.title')).toBeInTheDocument();
    expect(screen.getByText('sections.departmentsList.description')).toBeInTheDocument();
  });
  ...
  it('should render form inputs with proper labels', () => {
    ...
    // Check that form inputs are present with correct labels
    expect(screen.getByLabelText('fields.departmentName.label')).toBeInTheDocument();
    expect(screen.getByLabelText('fields.departmentAbbr.label')).toBeInTheDocument();
  });
  ...
  it('should show department name in confirmation dialog', async () => {
    ...
    // Should show department name in confirmation message
    await waitFor(() => {
      expect(screen.getByText(/Publishing Archiving and Digitization/)).toBeInTheDocument();
    });
  });
