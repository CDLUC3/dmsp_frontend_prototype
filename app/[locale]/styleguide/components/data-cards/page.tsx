    ...
    <LayoutContainer>
      <ContentContainer>
        ...
        >
          ...
          <span aria-hidden="true"> / </span>
          <span aria-current="page">Data Cards</span>
        </nav>
        ...
        <section id="template-list">
          ...
          <SGComponentExample>
            <SGComponentExampleHeader title="Template List with Selection" />
            <SGComponentExampleContent>
              <SGComponentExampleDemo>
                <div
                  style={{
...
<ProjectListItem item={project} />`}</SGCodeBlock>
...
/>`}</SGCodeBlock>
        ...
        <section id="implementation">
          ...
          <SGGuidelinesGrid>
            ...
            <SGGuidelineItem title="State Management">
