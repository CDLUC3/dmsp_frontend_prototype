      ...
      expect(mockAddQuestionMutation).toHaveBeenCalledWith({
        variables: {
          input: {
            ...
            json: "{\"type\":\"radioButtons\",\"attributes\":{\"label\":\"Number\"},\"meta\":{\"schemaVersion\":\"1.0\"},\"options\":[{\"label\":\"Yes\",\"value\":\"Yes\",\"selected\":false}]}",
            requirementText: '',
            guidanceText: '',
            sampleText: '',
      ...
      expect(mockAddQuestionMutation).toHaveBeenCalledWith({
        variables: {
          input: {
            ...
            isDirty: true,
            questionText: 'New Question',
            json: "{\"type\":\"text\",\"attributes\":{\"label\":\"Number\",\"maxLength\":1000,\"minLength\":0,\"pattern\":\"^.+$\"},\"meta\":{\"schemaVersion\":\"1.0\"}}",
            requirementText: '',
            guidanceText: '',
            sampleText: '',
            useSampleTextAsDefault: false,
      ...
      expect(mockAddQuestionMutation).toHaveBeenCalledWith({
        variables: {
          input: {
            ...
            isDirty: true,
            questionText: 'New Question',
            json: "{\"type\":\"textArea\",\"attributes\":{\"label\":\"Number\",\"cols\":40,\"maxLength\":1000,\"minLength\":0,\"rows\":20,\"asRichText\":true},\"meta\":{\"schemaVersion\":\"1.0\"}}",
            requirementText: '',
            guidanceText: '',
            sampleText: '',
            useSampleTextAsDefault: false,
      ...
      expect(mockAddQuestionMutation).toHaveBeenCalledWith({
        variables: {
          input: {
            ...
            isDirty: true,
            questionText: 'New Question',
            json: "{\"type\":\"number\",\"attributes\":{\"label\":\"Number\",\"max\":10000000,\"min\":0,\"step\":1},\"meta\":{\"schemaVersion\":\"1.0\"}}",
            requirementText: '',
            guidanceText: '',
            sampleText: '',
            useSampleTextAsDefault: false,
      ...
      expect(mockAddQuestionMutation).toHaveBeenCalledWith({
        variables: {
          input: {
            ...
            isDirty: true,
            questionText: 'New Question',
            json: "{\"type\":\"currency\",\"attributes\":{\"label\":\"Number\",\"max\":10000000,\"min\":0,\"step\":0.01,\"denomination\":\"GBP\"},\"meta\":{\"schemaVersion\":\"1.0\"}}",
            requirementText: '',
            guidanceText: '',
            sampleText: '',
            useSampleTextAsDefault: false,
      ...
      expect(mockAddQuestionMutation).toHaveBeenCalledWith({
        variables: {
          input: {
            ...
            isDirty: true,
            questionText: 'New Question',
            json: "{\"type\":\"url\",\"attributes\":{\"label\":\"Number\",\"maxLength\":2048,\"minLength\":2,\"pattern\":\"https?://.+\"},\"meta\":{\"schemaVersion\":\"1.0\"}}",
            requirementText: '',
            guidanceText: '',
            sampleText: '',
            useSampleTextAsDefault: false,
