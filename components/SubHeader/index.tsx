...
function SubHeader() {
  return (
    <div className={styles['c-subheader']}>
      <a className={`${styles['c-logo-org']} ${styles['has-new-window-popup-info']}`} href="http://cdlib.org/services/uc3" target="_blank" rel="noreferrer">
        <Image
      ...
      <ul className={styles['c-links-org']}>
        ...
        <li>
          <a href="http://www.ucop.edu/" className="c-links-org__ucop" target="_blank" rel="noreferrer">
