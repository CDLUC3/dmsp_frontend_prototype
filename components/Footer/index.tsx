          ...
          <div className={`${styles['dmpui-frontend-container']} ${styles['dmpui-frontend']}`}>
            <div className={styles['footer-links-grid']}>
              <div className={styles['footer-links-logo']}>
                <Image src='/images/DMP-logo-white.svg' className={styles.icon} width={230} height={33} alt="DMP Tool" />
                <p>
              ...
              <div className={styles['footer-links-external']}>
                ...
                <ul>
                  <li><a href="https://github.com/cdluc3/dmptool/wiki" target="_blank" rel="noreferrer">GitHub</a></li>
                  <li><a href="https://blog.dmptool.org" target="_blank" rel="noreferrer">Blog</a></li>
                  <li><a href="https://www.cdlib.org/about/accessibility.html" target="_blank" rel="noreferrer">Accessibility</a></li>
                </ul>
              </div>
            </div>
          </div>
